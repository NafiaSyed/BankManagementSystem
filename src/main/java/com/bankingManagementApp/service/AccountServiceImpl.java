...
import com.bankingManagementApp.repository.AccountRepository;
...
public class AccountServiceImpl implements AccountService {
	...
	@Override
	public Account getAccountDetailsByNumber(Long accountNumber) {
	...
	public void closeAccount(Long accountNumber) {
		getAccountDetailsByNumber(accountNumber);
