package com.bankingManagementApp.controller;
...
import com.bankingManagementApp.service.AccountService;
...
public class AccountController {
	...
	public Account getAccountByAccountNumber(@PathVariable Long accountNumber) {
		Account account = service.getAccountDetailsByNumber(accountNumber);
		return account;
	}
